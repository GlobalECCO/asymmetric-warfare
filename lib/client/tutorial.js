    ...
    Tutorial.prototype.initStateTutorialSteps = function() {
      ...
      self.script = [
...

        {
          ...
          tip: {
            title: 'Insurgents',
            content: 'The Insurgent player starts with 5 pieces on the map, but you can only see them when they are in the same space as any other piece (Insurgent or State).',
            tipJoint: 'top',
          },
        ...
        [{
          ...
          tip: {
            title: 'Crossing Rings',
            content: 'Moving from one ring to the next costs 2 movement points, with the exception of moving into or out of the Capital.',
            offset: [5, 0],
            tipJoint: 'bottom',
          },
          action: null,
        ...
        [{
          ...
          tip: {
            ...
            content: 'Interrogation shadow pieces are only accurate at the time of the interrogation, so you won\'t know if the Insurgent moves before you move a piece there.',
            tipJoint: 'bottom',
          },
          action: null,
        },
    ...
    Tutorial.prototype.initInsurgentTutorialSteps = function() {
      self.script = [
...

        {
          ...
          tip: {
            title: 'Setup',
            content: 'The Insurgent player starts with five pieces that you can place on the outermost ring of the map.',
            tipJoint: 'top',
            offset: [0, -3],
            stemLength: 20,
          },
        ...
        [{
          ...
          tip: {
            title: 'State Pieces',
            content: 'The State player has 5 pieces that are trying to find the Insurgent pieces.',
            tipJoint: 'bottom',
          },
          action: null,
        },
        ...
        [{
          ...
          tip: {
            title: 'Insurgent Victory',
            content: 'The Insurgent player wins if you have Insurgent pieces occupying either four adjacent spaces or six non-adjacent spaces in the Inner Circle (the ring adjacent to the Capital).',
            tipJoint: 'bottom',
          },
          action: null,
        },
        ...
        [{
          ...
          tip: {
            title: 'Crossing Rings',
            content: 'Changing which ring a piece is on takes 2 movement points.  Insurgent pieces cannot enter the Capital.',
            tipJoint: 'right',
          },
          action: null,
        },
        ...
        [{
          ...
          tip: {
            title: 'Ring Movement',
            content: 'It costs 1 movement point to move from one space to another in the same ring.  Movement can be split between two pieces or all used on one piece.',
            tipJoint: 'right',
          },
          action: null,
        },
        ...
        [{
          ...
          tip: {
            title: 'State Kill',
            content: 'As well as interrogating Insurgents, the State pieces can kill all Insurgent pieces in a shared space in one turn.  The State wins if 12 Insurgents are killed or if they only have 1 piece on the board.',
            tipJoint: 'top',
          },
