...
function(_, allong, C, Position, InsurgentMove, StateMove) {
  ...
  function modifyHighlight($space, params, override) {
    var data = $space.data('maphilight') || {};
    var strokeStart = {
      color: data.strokeColor || (data.strokeStart && data.strokeStart.color) || params.strokeColor,
      width: data.strokeWidth || (data.strokeStart && data.strokeStart.width) || params.strokeWidth || 5,
      opacity: data.strokeOpacity || (data.strokeStart && data.strokeStart.opacity) || 0,
      elapsed: params.hasOwnProperty('strokeColor') || params.hasOwnProperty('strokeWidth') || params.hasOwnProperty('strokeOpacity')? 0: (data.strokeStart && data.strokeStart.elapsed) || 0,
    };
    var fillStart = {
      color: data.fillColor || (data.fillStart && data.fillStart.color) || params.fillColor,
      opacity: data.fillOpacity || (data.fillStart && data.fillStart.opacity) || 0,
      elapsed: params.hasOwnProperty('fillColor') || params.hasOwnProperty('fillOpacity')? 0: (data.fillStart && data.fillStart.elapsed) || 0,
    };

    var strokeEnd = {
      onFinished: params.onStrokeFinished || (data.strokeEnd && data.strokeEnd.onFinished) || undefined,
    ...
    var fillEnd = {
      onFinished: params.onFillFinished || (data.fillEnd && data.fillEnd.onFinished) || undefined,
    ...
    if (!override && data.hasOwnProperty('override')) {
      ...
      data.alwaysOn = strokeStart.opacity > 0 || fillStart.opacity > 0 || strokeEnd.opacity > 0 || fillEnd.opacity > 0;
  ...
  function markSafe($space) {
    modifyHighlight($space, {fillColor:'FFFFFF', fillOpacity:0.5, fillFade:200});
  }
  ...
  function markMoveable($space) {
    flashHighlight($space,
      [{strokeColor:darkGreen, strokeWidth:5, strokeOpacity:1, strokeFade:500, fillColor:"FFFFFF", fillOpacity:0.1, fillFade:500},
      {strokeColor:medGreen, strokeWidth:5, strokeOpacity:1, strokeFade:500, fillColor:"FFFFFF", fillOpacity:0.1, fillFade:500}], 200);
  }
  ...
  function markSelected($space) {
    if (!isPlayback) {
      flashHighlight($space,
        [{strokeColor:lightGreen, fillColor:'FFFFFF', strokeWidth:5, fillOpacity:0.5, strokeFade:500, fillFade:500}], 500);
